...
\itm Integrate $f(x,y,z) = x^2+y+z$ over the pentahedron with vertices $(0,0,0)$, $(1,0,0)$, $(0,2,0)$, $(1,2,0)$, $(0,0,4)$ and $(1,0,4)$. 

\sol{We evaluate 
\[
\int_{0}^{1}\int_{0}^{2}\int_{0}^{4-2y} x^2+y+z\, dz \,dy \,dx = \boxed{28/3}. \qedhere
\]}{}

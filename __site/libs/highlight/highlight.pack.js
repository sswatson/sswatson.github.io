...
starts:{end:/^(?![ ]{6})/,subLanguage:"julia"},aliases:["jldoctest"]}]})})());hljs.registerLanguage("yaml",(()=>{"use strict";return e=>{
...
aliases:["yml","YAML"],contains:b}}})());hljs.registerLanguage("haskell",(()=>{"use strict";return e=>{const n={
